...
export const ICONS: Record<string, string> = {
  ...
  // „יציאה” = משקוף עם חץ שיוצא ממנו. החץ פונה **שמאלה** ולא ימינה כמו ב-
  // `export`: הממשק עברי, וכיוון ההתקדמות בו הוא מימין לשמאל — חץ ימינה היה
  // נקרא כחזרה. המשקוף בצד ימין מאותו טעם: יוצאים ממנו והלאה.
