...
/**
 * טווח יחס המילוי: המידה הדומיננטית של ה-bounding box חייבת לתפוס 70%–84%
...
describe('אתרי הקריאה לאייקונים', () => {
  ...
  it('פעולות הקובץ מקבלות אייקונים נפרדים ונכונים', () => {
    ...
    const fileTab = readFileSync(join(SRC, 'ui/ribbon/tabs/FileTab.vue'), 'utf8');
