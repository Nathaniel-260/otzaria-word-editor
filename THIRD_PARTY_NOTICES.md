...
> **65 מתוך 75 האייקונים** ב־`icons.ts` הם Fluent System Icons. עשרת היוצאים
...
> - `pageNumber`, `dateTime`, `updateFields` — „מספר עמוד”, „תאריך ושעה”
>   ו„עדכן שדות”. הפעם הסיבה אינה היעדר גליף אלא היעדר ה־path data עצמו:
>   ההצהרה הזאת מכסה path data **מקורי**, כפי שהוא בחבילה של Microsoft, ולא
>   שחזור מהזיכרון של גליף דומה. שחזור כזה אינו הקוד של Microsoft ואינו זכאי
>   להצהרה עליו, ולכן שלושתם צוירו בבית — על אותה טבעת דף של ארבעת שכניהם,
>   כדי ששורת הפקדים תישאר במשקל אחד.
