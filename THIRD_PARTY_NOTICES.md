...
13,105 ראשי-תיבות ופירושיהם ממילון אוצריא הרשמי. זהו נתון ספרייה של אוצריא,
ולא תוכן של ספר חיצוני. הוא נארז כנכס מקומי נפרד ונטען רק כאשר נדרשת השלמה;
הוא אינו נכלל ב־`assets/app.js`.
