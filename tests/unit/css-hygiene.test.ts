 ...
 * ל-0 ול-3; מחיקת כלל אחר לא שינתה דבר. הסיפור המלא בהערה על באנר
 * `edit-rejected` ב-engine-chrome.css (הכלל עצמו נמחק כשהמנוע הפסיק לצייר את
 * הבאנר), והמדידה החוזרת ב-scripts/qa/typing-style-recalc-qa.mjs.
 *
