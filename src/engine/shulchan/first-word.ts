 ...
 *
 * ההבדל מהמקור: אין ב-SuperDoc יצירת סגנון תו (נמדד — docs/engine-gaps.md,
 * „אין פעולה שמגדירה סגנון בשם”), ולכן המסלול היחיד הוא עיצוב ישיר,
 * בערכים שנגזרים מגוף הפסקה עצמה (מקביל למצב
