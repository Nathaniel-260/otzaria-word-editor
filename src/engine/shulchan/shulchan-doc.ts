...
/**
 * מזהה יציב למסמך, לזיכרון של כלים שמצבם אינו בקובץ (סימון עמודים, סימני
 * חיתוך): FNV-1a על מזהי הבלוקים (`w14:paraId`), שנשמרים ב-docx ושורדים
 * עריכה של הטקסט. עריכה שמוסיפה/מוחקת פסקאות משנה את המפתח — ואז הזיכרון
 * פשוט לא יימצא, וזה עדיף על התאמה למסמך אחר.
 */
