...
/**
 * גופן או גודל שהוחלו. אין `run` להעלות — הפקד הריץ את הפקודה בעצמו, בדיוק
 * כמו כפתור של פקודת מנוע — ומה שנשאר הוא הסגירה, שהיא ההתנהגות של כל פעולה
 * אחרת בכרטיס: פעולה אחת, והכרטיס נעלם.
 */
