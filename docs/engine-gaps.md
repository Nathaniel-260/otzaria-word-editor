...
לא נשלח למעלה: הקוד שמזיז את הסמן אינו בחלקים הפתוחים של SuperDoc — בעץ
המקור יש רק הצהרת טיפוסים — והרישיון אוסר לפרסם מדידות של המנוע. אם יידווח —
כתיאור איכותי בלבד („End בפסקת RTL מתנהג כמו Home”), בלי הטבלה.
