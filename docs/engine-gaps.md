...
**ומה שחסר:** אין במאגר שום בדיקה שמכסה גלילה — גם `multi-doc-qa.mjs` אינו
נוגע בה — ולכן רגרסיה במנוע לא תיתפס היום. הגשש של הסבב הזה הוא המועמד
הטבעי להפוך לשער, וזו עבודה פתוחה.
