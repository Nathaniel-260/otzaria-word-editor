...
לא יטייל שורה-שורה; המחיר הוא ש-`Home` ואז `End` בשורה גולשת שנייה נשאר בתפר.
הקלדה בתפר, לעומת זאת, אכן מעבירה את הסמן לשורה הבאה (נמדד: נקודה שהוקלדה
בהיסט 98 נכנסה לתיבת השורה השנייה), ולכן `End` שאחריה מגיע לסוף השורה השנייה.
