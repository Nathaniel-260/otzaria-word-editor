# מסמך עבודה — תוסף Word לאוצריא (תמצית מ־ai.md)

תמצית ההחלטות והעובדות מתוך [ai.md](../ai.md) שרלוונטיות בפועל לבניית התוסף.
תכנית העבודה המחייבת: [word-plugin-implementation-plan.md](word-plugin-implementation-plan.md).
